...
char ssid[] = "AndroidAP3DEC";     // Wifi Name

char password[] = "123456"; // Wifi Password

// Initialize Telegram BOT

#define BOTtoken "5046061617:AAGM5mOCbPLZ4j92BwCSexfyzQIgyvAWmL8" // Bot token from telegram app
